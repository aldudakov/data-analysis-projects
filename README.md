...
| [Статистический анализ тарифов](statistical_analysis_of_tariffs) | Выбрать более прибыльный тариф оператора связи на основании информации о пользователях, звонках, сообщениях, интернет-сессиях и тарифах | *pandas*, *matplotlib*, *numpy*, *scipy* |
