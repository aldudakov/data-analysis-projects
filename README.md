...
| [Анализ бизнес-показателей приложения](business_indicators_analysis) | Исследование причин, по которым компания терпит убытки с импользованием основных бизнес показателей (конверсии, удержания, LTV, ROI) | *pandas*, *matplotlib*, *numpy*, *datetime* |
